; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Documents and Settings\Jorge Fernandez\Desktop\Sistemas Operativos I\2016-ii-1272-so1-osdevseries-jorgefer00\tutorial15\SysCore\Kernel\DebugDisplay.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\documents and settings\jorge fernandez\desktop\sistemas operativos i\2016-ii-1272-so1-osdevseries-jorgefer00\tutorial15\syscore\kernel\debugdisplay.cpp
_TEXT	SEGMENT
_c$ = 8							; size = 1
...
_TEXT	SEGMENT
_i$ = -68						; size = 4
_str$2729 = -64						; size = 32
_str$2719 = -64						; size = 32
_str$2708 = -64						; size = 64
_str$ = 8						; size = 4
...
; 207  : 						strcpy (str,(const char*)c);
	...
	add	ebx, 4
	push	edx
	lea	eax, DWORD PTR _str$2708[esp+88]
	push	eax
	call	?strcpy@@YAPADPADPBD@Z			; strcpy

; 208  : 						DebugPuts (str);

	lea	ecx, DWORD PTR _str$2708[esp+92]
	push	ecx
...
; 218  : 						itoa_s (c, 10, str);
	...
	xor	eax, eax
	add	ebx, 4
	mov	BYTE PTR _str$2719[esp+84], 0
	mov	DWORD PTR _str$2719[esp+85], eax
	mov	DWORD PTR _str$2719[esp+89], eax
	mov	DWORD PTR _str$2719[esp+93], eax
	mov	DWORD PTR _str$2719[esp+97], eax
	mov	DWORD PTR _str$2719[esp+101], eax
	mov	DWORD PTR _str$2719[esp+105], eax
	mov	DWORD PTR _str$2719[esp+109], eax
	mov	WORD PTR _str$2719[esp+113], ax
	mov	BYTE PTR _str$2719[esp+115], al
	lea	ebp, DWORD PTR _str$2719[esp+84]
	test	ecx, ecx
	jns	SHORT $LN18@DebugPrint
	mov	BYTE PTR _str$2719[esp+84], 45		; 0000002dH
	lea	ebp, DWORD PTR _str$2719[esp+85]
	neg	ecx
$LN18@DebugPrint:
	xor	esi, esi
	test	ecx, ecx
...
; 219  : 						DebugPuts (str);
	...
	lea	eax, DWORD PTR _str$2719[esp+84]
	push	eax
	call	?DebugPuts@@YAXPAD@Z			; DebugPuts
...
; 228  : 						char str[32]={0};
	...
	xor	eax, eax
	add	ebx, 4
	mov	DWORD PTR _str$2729[esp+85], eax
	mov	DWORD PTR _str$2729[esp+89], eax
	mov	DWORD PTR _str$2729[esp+93], eax
	mov	DWORD PTR _str$2729[esp+97], eax
	mov	DWORD PTR _str$2729[esp+101], eax
	mov	DWORD PTR _str$2729[esp+105], eax
	mov	DWORD PTR _str$2729[esp+109], eax
	mov	WORD PTR _str$2729[esp+113], ax
	mov	BYTE PTR _str$2729[esp+115], al

; 229  : 						itoa_s (c,16,str);

	mov	eax, DWORD PTR [ebx]
	mov	BYTE PTR _str$2729[esp+84], 0
	lea	edi, DWORD PTR _str$2729[esp+84]
	test	eax, eax
	jns	SHORT $LN31@DebugPrint
	mov	BYTE PTR _str$2729[esp+84], 45		; 0000002dH
	lea	edi, DWORD PTR _str$2729[esp+85]
	neg	eax
$LN31@DebugPrint:
	xor	ecx, ecx
	test	eax, eax
...
; 230  : 						DebugPuts (str);
	...
	lea	eax, DWORD PTR _str$2729[esp+84]
	push	eax
	call	?DebugPuts@@YAXPAD@Z			; DebugPuts
$LN65@DebugPrint:
	add	esp, 4
